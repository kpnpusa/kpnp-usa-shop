...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your login link for KPNP America</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            Click the button below to log in to your KPNP America account. This link will expire shortly.
          </Text>
...
const button = { backgroundColor: '#111111', color: '#ffffff', fontSize: '15px', fontWeight: '700' as const, borderRadius: '5px', padding: '14px 36px', textDecoration: 'none' }
