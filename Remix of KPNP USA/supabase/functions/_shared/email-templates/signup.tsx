...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email for KPNP America</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            Thanks for creating your KPNP America account! Please confirm your email address ({recipient}) by clicking the button below:
          </Text>
