...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join KPNP America</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>
            You've been invited to join KPNP America. Click the button below to accept the invitation and create your account.
          </Text>
